...
## How to contribute?
It would be a huge help if you could read [our interface proposal](#interface-proposal-sample-features). If you like, you can also try out a prototype of the Mathemagical.js library. Either way, we welcome your feedback.
